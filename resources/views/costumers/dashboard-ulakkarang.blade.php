    ...
    <main class="min-h-screen bg-gray-100">
        ...
        <section class="max-w-6xl mx-auto py-12" id="lapanganUnggulan">
            ...
            <div class="min-h-[50vh] flex items-center justify-center px-4">
                <div class="max-w-md w-full text-center bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-200">
                    <!-- Icon Empty State -->
                    <div class="flex justify-center mb-6">
                        <div class="w-24 h-24 bg-gradient-to-br from-blue-100 to-blue-50 rounded-full flex items-center justify-center border-2 border-blue-200">
                            <svg class="w-12 h-12 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m0 0l8 4m-8-4v10l8 4m-8-4v10m0-10l8-4"></path>
                            </svg>
                        </div>
                    </div>
                    ...
                    <p class="text-gray-600 mb-6 text-sm leading-relaxed">
                        Admin belum menambahkan data lapangan untuk region Bukit Tinggi. Silakan cek kembali nanti atau hubungi admin untuk informasi lebih lanjut.
                    </p>

                    <div class="space-y-3">
                        <a href="#footer" class="block px-5 py-3 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700 transition font-semibold shadow-md">
                            📞 Hubungi Admin
                        </a>
                        <a href="/" class="block px-5 py-3 rounded-lg bg-gray-100 text-gray-700 text-sm hover:bg-gray-200 transition font-semibold">
                            ← Kembali ke Beranda
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition">
                    ...
                    <div class="p-4">
                        ...
                        {{-- BUTTON --}}
                        @if ($lp->status === 'tersedia')
                        <a href="{{ route('boking.form') }}?region=ulakkarang&lapangan_id={{ $lp->id }}">
                            <button
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-12">
            ...
            <div class="bg-white/80 backdrop-blur-md shadow-2xl p-6 md:p-8 rounded-3xl border border-gray-100 overflow-hidden">
                <div class="aspect-video w-full h-96 rounded-xl overflow-hidden shadow-inner">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.3101590127158!2d100.34667586957191!3d-0.9144637332653279!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b9d2c93b794f%3A0x4c9434941029d1b!2sRafhely%20Futsal%20Ulak%20Karang!5e0!3m2!1sid!2sid!4v1769850529742!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
    ...
    <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        <div id="wa-menu"
            ...
            <div class="p-4 space-y-3">
                ...
                <a href="https://wa.me/89508839313" target="_blank"
...
<script>
    // ✅ Pass booking data dari Laravel ke JavaScript
    const bookingData = {
        !!json_encode($bokings - > map(function($booking) {
            return [
