            ...
            <div class="min-h-[50vh] flex items-center justify-center px-4">
                <div class="max-w-md w-full text-center bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-200">
                    ...
                    <p class="text-gray-600 mb-6 text-sm leading-relaxed">
                        Admin belum menambahkan data lapangan untuk region Sijunjung. Silakan cek kembali nanti atau hubungi admin untuk informasi lebih lanjut.
                    </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition">
                    ...
                    <div class="p-4">
                        ...
                        {{-- BUTTON --}}
                        @if ($lp->status === 'tersedia')
                        <a href="{{ route('boking.form') }}?region=batusangkar&lapangan_id={{ $lp->id }}">
                            <button
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-12">
            ...
            <div class="bg-white/80 backdrop-blur-md shadow-2xl p-6 md:p-8 rounded-3xl border border-gray-100 overflow-hidden">
                <div class="aspect-video w-full h-96 rounded-xl overflow-hidden shadow-inner">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.71270457426!2d100.59185627396921!3d-0.41689473529178195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd5333df0b8e417%3A0x72b8a173c2ddf8a6!2sRafhely%20Futsal%20Tanah%20Datar!5e0!3m2!1sid!2sid!4v1769850642020!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
    ...
    <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        <div id="wa-menu"
            ...
            <div class="p-4 space-y-3">
                ...
                <a href="https://wa.me/6289508839313" target="_blank"
...
<script>
    ...
    const region = '{{ $region ?? "batusangkar" }}';
</script>
<script>
