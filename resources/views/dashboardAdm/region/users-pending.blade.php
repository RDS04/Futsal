            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="card-title font-weight-bold mb-0">
                        <i class="fas fa-clock mr-2"></i> User Pending Pembayaran - {{ $regionLabel }}
                    </h3>
                    <p class="text-muted mb-0 text-sm">
                        Daftar user yang belum menyelesaikan proses pembayaran
                    </p>
                </div>
        ...
        <div class="card-body">
                    ...
                    <table class="table table-hover table-striped table-bordered align-middle">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th width="110" class="text-center">Tanggal Registrasi</th>
            ...
            @else
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <strong>Info:</strong> Semua user di region ini sudah menyelesaikan pembayaran!
