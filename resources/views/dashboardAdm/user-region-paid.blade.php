        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h3 class="card-title font-weight-bold">
                    <i class="fas fa-money-check-alt mr-2"></i> User Sudah Melakukan Pembayaran
                </h3>
                ...
                <table class="table table-hover table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($user->region)
                                    <h3 class="badge badge-info px-3 py-1" style="color: #000;">
                                        {{ $user->region }}
                                    </h3>
                                @else
                                    <h3 class="badge badge-secondary" style="color: #000;">Tidak Ada</h3>
                                @endif
                            </td>

                            <td>
                                @if($user->payment_status === 'paid')
                                    <h3 class="badge badge-success px-3 py-1" style="color: #000;">
                                        <i class="fas fa-check-circle mr-1"></i> Sudah Bayar
                                    </h3>
                                @elseif($user->payment_status === 'pending')
                                    <h3 class="badge badge-warning px-3 py-1" style="color: #000;">
                                        <i class="fas fa-clock mr-1"></i> Pending
                                    </h3>
                                @else
                                    <h3 class="badge badge-secondary px-3 py-1" style="color: #000;">
                                        -
                                    </h3>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">
                                ...
                                Tidak ada user yang sudah melakukan pembayaran
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
